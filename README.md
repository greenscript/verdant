TARGET:CLAUDE
NOTE:Structured data with technical notation
---
F:README.md
# Verdant v2.3
**Advanced Markdown Compression for AI Consumption**
Verdant is specialized tool that compresses markdown files into dense, AI-readable format while preserving all important content. Perfect for fitting large DOC sets into AI context windows with intelligent chunking, model-specific optimization, and new VRD (AI-native) format.
## Features
...
## New in v2.3
- ** VRD Format**: New AI-native format that achieves 17% fewer chunks than standard Markdown
...
- ** Better Information Density**: ~63KB per chunk vs ~54KB for MD format (17% improvement)
...
2. **Dictionary Compression**: Common terms abbreviated (FN=FN, API=application programming interface)
...
## Use Cases
- **AI Context Optimization**: Fit more DOC into ChatGPT/Claude prompts
...
*"Because your DOC shouldn't fight your AI assistant"*
